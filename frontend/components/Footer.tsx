        ...
        <footer className="w-full flex flex-col">
            <div className='flex w-full pl-26 pr-26'>
                ...
                <div className="flex w-full flex-2 gap-6 justify-between pl-50">
                    ...
                    <h1 className="flex font-medium text-teal-500">Features</h1>
                        <h2 className="flex font-medium text-indigo-500">CSV Upload</h2>
                        <h2 className="flex font-medium text-indigo-500">Extension</h2>
                        <h2 className="flex font-medium text-indigo-500">Dashboard</h2>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-3">
                    <h1 className="flex font-medium text-teal-500">Pages</h1>
                        <h2 className="flex font-medium text-indigo-500">About Us</h2>
                        <h2 className="flex font-medium text-indigo-500">Features</h2>
                        <h2 className="flex font-medium text-indigo-500">Pricing</h2>
                    </div>
                </div>
            </div>
            <div className='flex w-full bg-indigo-500 h-16 items-center pl-26 pr-26 justify-between'>
                <div className='flex items-center justify-start gap'>
                    <h1 className='flex items-center text-white font-normal'>Copyright ©2025 Rafael Satyro. All Right Reserved</h1>
                </div>
                <div className="flex items-center justify-end gap-12">
                    <h1 className='flex items-center text-white font-normal'>Cookie Policy</h1>
                    <h1 className='flex items-center text-white font-normal'>Privacy Policy</h1>
                    <h1 className='flex items-center text-white font-normal'>Contact Us</h1>
                </div>
