        ...
        <div className="fade-slide-up flex w-full flex-col md:flex-row ">
            <div className="flex flex-col items-center w-full h-screen">
                <div className="pl-4 pt-5 sm:pl-4 md:pl-6 lg:pl-10 flex w-full lg:pt-10 items-center gap-3">
                    ...
                    <h1 className="flex font-normal text-xl text-indigo-500 pt-1 cursor-pointer fade-title">Reset Password</h1>
                </div>
                ...
                <div className="flex flex-col w-full pt-10 pl-10 pr-10 md:pt-10 md:pr-10 md:pl-10 lg:pl-20 lg:pr-20 lg:pt-10 2xl:pr-65 2xl:pl-65">
                    <div className="flex flex-col">
                        ...
                        <input type="text" placeholder="Insert your email here..." className='fade-title border rounded border-indigo-500 pt-2 pr-2 pb-2 pl-4 outline-indigo-500 text-indigo-500 placeholder-gray-400' />
                    </div>
                    <div className="flex flex-col pt-12">
                        <p className="flex w-full font-normal text-teal-500 pb-1 fade-title">Password</p>
                        <input type="text" placeholder="Insert your new password here..." className='fade-title border rounded border-indigo-500 pt-2 pr-2 pb-2 pl-4 outline-indigo-500 text-indigo-500 placeholder-gray-400' />
                    </div>
                </div>
                <div className='flex w-full flex-col pt-20 sm:pt-16 md:pt-14 lg:pt-12 2xl:pt-20'>
                    <div className='flex justify-center gap-2'>
                        <button className='bg-teal-500 p-2 rounded text-white w-45 cursor-pointer fade-title'>Reset Password</button>
                    </div>
                </div>
          </div>
